  ...
  <div class="box">
   <table  style ="border-color:red; font-size:16pt"  align="center" width="100%" height="100%">
      <tr>
       ...
       <tr>
          <td align="center"><b><i><mark style="color:white;background-color:maroon";>Delete BOOKS</mark></i></b></td>
        </tr>
    </table>
  </div>
<div class="nav">
<ul>
  ...
  <li ><a href = "add_book.php" >Add Book</a></li>
    <li><a href = "delbook.php"  style="background-color:#660000">Delete Book</a></li>
